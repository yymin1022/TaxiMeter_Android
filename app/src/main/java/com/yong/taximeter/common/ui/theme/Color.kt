...
// Meter UI Colors
val MeterBackgroundDark = Color(0xFF111111)
val MeterBackgroundLight = Color(0xFFF0F0F0)
val MeterTextPrimaryDark = Color(0xFFEEEEEE)
val MeterTextPrimaryLight = Color(0xFF111111)
val MeterTextSecondaryDark = Color(0xFFCCCCCC)
